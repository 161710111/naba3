    ...
    <div class="container">
        <div class="col-md-12">
            <div class="panel panel-primary">
              <div class="panel-heading">Galeri Home
                <div class="panel-title pull-right"><a class="btn btn-warning" href="{{ route('galerihome.create') }}">Tambah</a>
                </div>
              </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <form method="post" action="{{ route('galerihome.destroy',$data->id) }}">
